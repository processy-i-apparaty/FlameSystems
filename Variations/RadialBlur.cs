...
namespace Variations
{
    public class RadialBlur : VariationModel
    {
        ...
        public override Point Fun(Point p)
        {
            ...
            var n2 = VariationHelper.Random() + VariationHelper.Random() + VariationHelper.Random() +
                     VariationHelper.Random() - 2.0;
//            var n2 = VariationHelper.Random() * 3.0 + VariationHelper.Random() - 2.0;
            ...
            var n5 = Math.Atan2(p.Y, p.X) + n3 * n2;
            var sin = Math.Sin(n5);
            var cos = Math.Cos(n5);
            var n6 = n4 * n2 - 1.0;
