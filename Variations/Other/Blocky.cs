...
namespace Variations.Other
{
    public class BlockY : VariationModel
    {
        ...
        public override Point Fun(Point p)
        {
            ...
            var y = P2;
            var mp = P3;
            var v = W / VariationHelper.HalfPi;
            ...
            var n8 = p.X / n6;
            point.X += v * Math.Atan2(n8, SqrtSafe(1.0 - VariationHelper.Sqr(n8))) * n2 * x;
            var n9 = p.Y / n7;
            point.Y += v * Math.Atan2(n9, SqrtSafe(1.0 - VariationHelper.Sqr(n9))) * n2 * y;
